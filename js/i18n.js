...
<div class="modal-btns"><button class="btn primary" data-cmd="m-close">{{ok}}</button></div>`,
      ...
      // ---------------- 统一编辑器：全量覆盖（整份 CPC 块语法） ----------------
      ed_link_title: "全量覆盖",
      ed_link_hint: "粘贴整份 CPC 块语法文本，整体覆盖画板——文本里没写的人物与连线会被删除。",
      ed_link_ph: "#标题{我的CP图；!填表人：我的名字}\n.布局{0：甲；1：乙，丙，丁}\n@关系{爱情：甲 -> 乙；宿敌：丁 -> 戊}\n!喜好 原子{本命：甲；很喜欢：乙，丙}",
      // ⚠️ 提示文案若写成多行，必须用反引号（模板字符串）包裹；用双引号跨行 = 语法错误会整站崩
      ed_link_help: `块语法（可只写需要的块）：<br>
<code>#标题{}</code> 图名，可含 <code>!填表人：</code>、作品、时间（条目用 <code>；</code> 分隔）<br>
<code>.布局{}</code> <code>0：圆心；1：甲，乙，丙</code>（圈号：人名；<code>1(8)：</code> 声明 8 槽；<code>1[6,150px]：</code> 指定槽数与半径）<br>
<code>@关系{}</code> <code>爱情：甲 -> 乙</code>（<code>-</code> 无向 / <code>-&gt;</code> 单向 / <code>&lt;-&gt;</code> 双向；<code>*</code> 未命名连线）<br>
<code>!喜好 原子{}</code> <code>本命：甲</code>（涂角色圆圈）；<code>!喜好 关系{}</code> <code>很喜欢：甲 * 乙</code>（垫在线下）<br>
粗线词（本命/很喜欢/路好/不吃）＝有多喜欢；细线词（爱情/友情/亲情/QPR）＝是什么关系；同一对可叠加。<br>
<b>本页是「全量覆盖」：整份替换画板，文本里没写的会被删除。只做增量请到「批量录入」Tab。</b>`, 
