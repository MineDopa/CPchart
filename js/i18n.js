 ...
 *
 * 加新语言示例：
 *   I18N.loadPack('en', { help_title: "CPChart Guide", help_body: "...", ... });
 *   I18N.setLang('en');
 */
(function () {
  var pack = {
  ...
  <div class="help-tab"><b>视图</b>：纯看图、隐藏界面截图、存图片</div>
...
<div class="modal-btns"><button class="btn primary" data-cmd="m-close">{{ok}}</button></div>`,
      ...
      // ---------------- 欢迎引导 ----------------
      welcome_title: "连接你的世界",
      welcome_guide: "角色名单填写说明：<code>圆心: A</code>、<code>1: B，C，D</code> → 绘制以 A 为圆心、第一圈顺时针依次摆放 B、C、D 的 CPChart 图表。圆心可以不写。",
      ...
      ed_link_help: `恭喜！你找到了 CPChart 的高级用法。你可以在这里批量导入导出、编辑文字，甚至让 AI 帮你分析你喜欢什么样的关系。<br>
在认识语法之前，最快的路径是<b>先动手走一遍</b>：<br>
【人物】导入角色 → 【连线】画 3 条箭头与粗细不同的线 → 切到人物模式画喜好度 → 【样式】建一个自定义词和颜色 → 【布局】打开一次槽位、拖一次半径 → 【视图】隐藏界面看一眼成品。<br>
回来后你会发现，下面的数据已经跟着变了。<br><br>
<b>下面是一份完整的例子</b>（「.」开头的块可以整段复制给别人复用），再逐段认识它：<br>
<div class="ed-code"><code>#标题{我的关系图；!填表人：你的名字}</code><br><code>.布局{0：甲；1[4,150px]：乙， ，丙，丁；2：戊，己}</code><br><code>@关系{崇拜：甲 -> 乙；爱情：乙 &lt;-&gt; 丙；友情：丁 * 戊}</code><br><code>!喜好 原子{本命：甲}</code><br><code>!喜好 关系{很喜欢：甲 * 乙}</code><br><code>.样式{ 爱情: #031499 }</code></div>
<b>【#标题{}】</b>图名与署名。<b>「！」</b>是只有你能填、AI 不能代写的部分：你的喜好，你的感受，你对这些 CP 的理解。<b>「你」不在这张表上，「你」无处不在。</b>所以好好写上 <code>!填表人：你的名字</code>，然后展示表格吧。<br><br>
<b>【.布局{}】</b>决定谁在图上、谁离圆心近。<code>0</code> 是圆心，通常写主角，群像作品可以留空；圈号越大，人越靠外。<code>1[4,150px]</code> 读作：第 1 圈画 <b>4 个槽位</b>、这一圈<b>半径 150px</b>。<br>
<b>槽位可以比人多</b>：多出来的空位会画成虚线小圈占位，间距就不会挤在一起；也可以像 <code>乙， ，丙，丁</code> 这样把第二个位置空着。<br><br>
<b>【@关系{}】</b>谁和谁是什么关系。<code>-></code> 单向，<code>&lt;-&gt;</code> 互相，<code>*</code> 不分方向（<code>&lt;-&gt;</code> 相当于一条 <code>*</code> 加上 <code>-&gt;</code> 和 <code>&lt;-</code>）。<br>
粗线画笔 = 填表人有多喜欢（本命 / 很喜欢 / 路好 / 不吃）；细线画笔 = 是什么关系（爱情 / 友情 / 亲情 / QPR）。<br><br>
<b>【!喜好{}】</b><code>原子{}</code> 里写角色，<code>关系{}</code> 里写一对 —— 一对 CP 由两个人组成，但「喜好」标记的 AB 是「一个对象」，也就是「超点」。<br><br>
<b>【.样式{}】</b>是图例：每个「词」的颜色和外貌。每个词属于两类之一：<code>favor</code>（喜好度）与 <code>relation</code>（关系型）—— 区别很直接：是「我」喜欢这两个人的关系，还是「这两个人」本身是什么关系。新词只要写一个颜色，其余自动补全。<br>
你甚至可以把箭头指向写成「攻 → 受」再分享出去，让 AI 看看你的口味 —— CPChart 奖励那些与众不同的差异：作者相信，正是偏离标准值的部分构成了你。哪怕是热门 CP 粉，也一样会有属于自己的「关系理解」。<br><br>
